...
func (l *zapLogger) Debug(msg string, args ...stdout.Arg) {
	fields := l.convertArgs(args...)
	l.logger.Debug(msg, fields...)
}
func (l *zapLogger) Info(msg string, args ...stdout.Arg) {
	fields := l.convertArgs(args...)
	l.logger.Info(msg, fields...)
}
func (l *zapLogger) Warn(msg string, args ...stdout.Arg) {
	fields := l.convertArgs(args...)
	l.logger.Warn(msg, fields...)
}
func (l *zapLogger) Critical(msg string, args ...stdout.Arg) {
	fields := l.convertArgs(args...)
	l.logger.Error(msg, fields...)
}

func (l *zapLogger) convertArgs(args ...stdout.Arg) []zap.Field {
